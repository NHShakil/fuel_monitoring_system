...
<script>
	function getSubZone(val) {
		$.ajax({
			type: "POST",
			url: "<?php echo Router::url(array('controller'=>'reports','action'=>'get_subzone'));?>",
			//url: "get_subzone",
			data:'id='+val,
		...
		$.ajax({
			type: "POST",
			url: "<?php echo Router::url(array('controller'=>'reports','action'=>'get_site'));?>",
			//url: "get_site",
			data:'id='+val,
			success: function(data){
				$("#site-name").html(data);
	...
	function getSubZoneid(val) {
		$.ajax({
			type: "POST",
			url: "<?php echo Router::url(array('controller'=>'reports','action'=>'get_parent_zone'));?>",
			//url: "get_parent_zone",
			data:'id='+val,
			success: function(data){
				$("#sub-zone-name").html(data);
	...
	function selectSite(val){
		$.ajax({
			type: "POST",
			url: "<?php echo Router::url(array('controller'=>'reports','action'=>'select_site_value'));?>",
		...
		$.ajax({
			type: "POST",
			url: "<?php echo Router::url(array('controller'=>'reports','action'=>'card_number'));?>",
			//url: "card_number",
			data:'SiteModuleId='+val,
			success: function(data){
				console.log(data);
       ...
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Reports :: Alert Log Report'); ?></h2>
        		</div>
        	</div>
    			...
    			<div class="col-md-12">
					<div class="row">
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
					      		<div class="panel panel-info">
	            					<div class="panel-heading"> Alert Log Report </div>
	            					<div class="panel-body">   
