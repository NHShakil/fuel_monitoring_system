...
<body class= "hold-transition login-page" style="color: #aaa; ">
	<div class="login-box">
    	<div class="login-logo">
    		<a href=""><b>M</b>assive<b>E</b>lectronics</a>
    	</div>
    	<div class="login-box-body">
    		...
    		<div class="row" style="margin-top:15px;">
                ...
                <div class="col-xs-4" style="float: left;">
                    <?php echo $this->Form->button('Reset',array('type'=>'reset','class' => 'btn btn-primary btn-block btn-flat','label'=>false));?>
                </div>
                
            	<div class="col-xs-4" style="float: right;">
            		<?php echo $this->Form->button('Login',array('type'=>'submit','class'=>'btn btn-primary btn-block btn-flat','label'=>false)); ?>
