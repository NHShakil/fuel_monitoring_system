...
<?php $this->assign('title', 'Alert Log Report');?>
<div class="content-wrapper">
    <section class="content">
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Reports :: Site Access Log History'); ?></h2>
        		</div>
        	</div>
    			...
    			<div class="col-md-12">
					<div class="row">
				      		...
				      		<div class="panel panel-info">
            					...
            					<div class="panel-body">
				    				...
				    				<div class="form_hieght">
					    				...
					    				<div class="col-md-6">
					    					<select id="site-name" name="site-name" class="form_width" required onchange="selectSite(this.value);">
				    				...
				    				<div class="form_hieght">
					    				...
					    				<div class="col-md-6">
					    					<input type="date" id="start-time" name="start-time" class="form_width">
										</div>
				    				</div>
				    				...
				    				<div class="form_hieght">
					    				...
					    				<div class="col-md-6">
					    					<input type="date" id="end-time" name="end-time" class="form_width">
										</div>
				    				</div>

				    				<div class="form_hieght">
					    				<label class="col-sm-6 control-label"> Card NO</label>
					    				<div class="col-md-6">
											<select id="card-number" name="card-number" class="form_width" onchange="cardNumber(this.value);">
				    				...
				    				<!-- <div class="form_hieght">
					    				<label class="col-sm-6 control-label"> Opened By </label> 
					    				<div class="col-md-6">
											<select id="open-by" name="open-by" class="form_width">
												<option value="">All</option>
												<?php
												    foreach ($door_open_by as $key => $value) {?>
												        <option value="<?php echo $value["DoorStatus"]["door_open_by"];?>"><?php echo $value['DoorStatus']['door_open_by'];?></option>
												        <?php 
												    }
												?>
											</select>
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
					      		<div class="panel panel-info">
	            					<div class="panel-heading"> Site All Access Log History </div>
	            					<div class="panel-body">   
																...
																if(count($door_status_data)>0){
																	foreach ($door_status_data as $key => $zone):?>
																		<tr class="">
																			...
																			<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo $site_name_data;?></td>
