       ...
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Log Pending Card Report'); ?></h2>
        		</div>
        	</div>
    			...
    			<div class="col-md-12">
					<div class="row">
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
					      		<div class="panel panel-info">
	            					<div class="panel-heading"><b>Log Pending Card Report</b> </div>
	            					<div class="panel-body">   
														...
														<tbody>
															<?php 
																if(count($assignedCardList)>0){
																	if($flag_zone==true){
																		foreach ($assignedCardList as $key => $value) {
																			foreach ($value as $key1 => $zone) {
																				foreach ($zone_data as $key => $value1) {
																					if($zone['AssignedCard']['zone_id']==$value1['Zone']['id']){
																						if($value1['Zone']['parent_id']!=''){
																							...
																							foreach ($zone_data as $key => $value) {
																								if($value1['Zone']['parent_id']==$value['Zone']['id']){ 
																									...
																									<tr>
																										<td style="font-size: 13px; padding-top: 14px;">
																											<span>
																												<?php 
																													echo "#";
																												?>	
																										...
																										<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo h($zone['AssignedCard']['site_name']);?></td>

																										<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo h($zone['AssignedCard']['card_number']);?></td>

																										<td style="font-size: 13px; font-family: 'Times New Roman',Georgia,Serif;">
																	                                        <?php echo h($zone['AssignedCard']['modified']); ?>
																										</td>

																										<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;">
																											<?php
																												$time_interval = number_format(time_interval($zone['AssignedCard']['modified']),0);
																												if($time_interval>90){
																													echo '<span style="color:red;">'.$time_interval.'</span>';
																												} 
																												else{
																													echo $time_interval;
																												}
																	...
																	elseif($flag_sub_zone==true){
																		//foreach ($testing_site_data as $key1 => $value) {
																			foreach ($assignedCardList as $key1 => $zone) {
																				foreach ($zone_data as $key => $value1) {
																					if($zone['AssignedCard']['zone_id']==$value1['Zone']['id']){
																						if($value1['Zone']['parent_id']!=''){
