...
<?php $this->assign('title', 'Instant Active Alarm Report');?>
<div class="content-wrapper">
    <section class="content">
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Instant Active Alarm Report'); ?></h2>
        		</div>
        	</div>
    			...
    			<div class="col-md-12">
					<div class="row">
				      	<div class="col-sm-4">
				      		<div class="panel panel-info">
            					...
            					<div class="panel-body">
				    				...
				    				<div class="form_hieght">
			                            <label class="col-sm-6 control-label">Alarm Name</label>
			                            <div class="col-md-6" id="open-by" name="open-by">
			                                <?php echo $this->Form->input('alarm_name', array('options'=>$alarm_name, 'class'=>'form_width','div'=>false,'label'=>false));?>
			                            </div>
			                        </div>
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
					      		<div class="panel panel-info">
	            					<div class="panel-heading"><b>Instant Active Alarm Site List</b> </div>
	            					<div class="panel-body">   
																								...
																								foreach ($zone_data as $key => $value) {
																									if($value1['Zone']['parent_id']==$value['Zone']['id']){ 
																										...
																										<tr class="">
																											...
																											<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;">
																		                                        <?php      
																		                                            if($zone['Testing']['alarm_1'] == 1){
																		                                            	echo '<span style="color:red;">'.'Active'.'</span>';
																		                                            }
																		                                            elseif($zone['Testing']['alarm_1'] == 0){
																		                                                echo 'Inactive';
																		                                            }   
																		                                        ?>
																											</td>
																											...
																											<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;">
																		                                        <?php      
																		                                            if($zone['Testing']['alarm_2'] == 1){
																		                                                echo '<span style="color:red;">'.'Active'.'</span>';
																		                                            }
																		                                            elseif($zone['Testing']['alarm_2'] == 0){
																		                                                echo 'Inactive';
																		                                            }   
																		                                        ?>
																											</td>
																											...
																											<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;">
																		                                        <?php      
																		                                            if($zone['Testing']['alarm_3'] == 1){
																		                                                echo '<span style="color:red;">'.'Active'.'</span>';
																		                                            }
																		                                            elseif($zone['Testing']['alarm_3'] == 0){
																		                                                echo 'Inactive';
																		                                            }   
																		                                        ?>
																											</td>
																											...
																											<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;">
																		                                        <?php      
																		                                            if($zone['Testing']['alarm_4'] == 1){
																		                                                echo '<span style="color:red;">'.'Active'.'</span>';
																		                                            }
																		                                            elseif($zone['Testing']['alarm_4'] == 0){
																		                                                echo 'Inactive';
																		                                            }   
																		                                        ?>
																											</td>
