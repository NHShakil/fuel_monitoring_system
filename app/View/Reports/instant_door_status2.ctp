    			...
    			<div class="col-md-12">
					<div class="row">
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
					      		<div class="panel panel-info">
	            					<div class="panel-heading"> Present Door Status(Open/Close/Unauthorized) Report </div>
	            					<div class="panel-body">   
																						...
																						if($value1['Zone']['parent_id']!=''){
																							...
																							foreach ($zone_data as $key => $value) {
																								if($value1['Zone']['parent_id']==$value['Zone']['id']){ 
																									...
																									<tr class="success">
																										<td class="td_height" style="font-size: 13px; padding-top: 14px;">
																											<span>
																												<?php 
																													echo $key1+1;
																												?>	
																										...
																										<td class="td_height" style="font-size: 13px; font-family: 'Times New Roman',Georgia,Serif;">
																											<?php
																												echo h($zone_name);
																											?>	
																										</td>
																										...
																										<td style="padding-left: 25px;">
																		                    				<ul class="list-inline" style="padding-top: 5px; font-size: 13px;">
																		                                        <?php
																						...
																						foreach ($zone_data as $key => $value) {
																							if($value1['Zone']['parent_id']==$value['Zone']['id']){ 
																								...
																								<tr class="data_row">
																									...
																									<td class="data_row_td"><?php echo h($zone['Testing']['site_name']);?></td>
																									<td class="data_row_td">
																									...
																									<td class="data_row_td"><?php echo h($zone['Testing']['full_date_time']); ?></td>
																								</tr><?php
																							}
																						}
																					}
