...
<?php $this->assign('title', 'Instant Lock Fail Report');?>
<div class="content-wrapper">
    <section class="content">
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Instant Lock Fail Report'); ?></h2>
        		</div>
        	</div>
    			...
    			<div class="col-md-12">
					<div class="row">
				      	<div class="col-sm-4">
				      		<div class="panel panel-info">
            					...
            					<div class="panel-body">
				    				...
				    				<div class="form_hieght">
			                            <label class="col-sm-6 control-label">Lock Status</label>
			                            <div class="col-md-6" id="open-by" name="open-by">
			                                <?php echo $this->Form->input('lock_status', array('options'=>$lock_status,'class'=>'form_width','div'=>false,'label'=>false));?>
			                            </div>
			                        </div>
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
					      		<div class="panel panel-info">
	            					<div class="panel-heading"><b>Instant Lock Fail Site List</b> </div>
	            					<div class="panel-body">   
