...
<?php $this->assign('title', 'Instant Reader Fail Report');?>
<div class="content-wrapper">
    <section class="content">
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Instant Card Reader Fail Site Report'); ?></h2>
        		</div>
        	</div>
    			...
    			<div class="col-md-12">
					<div class="row">
				      	<div class="col-sm-4">
				      		<div class="panel panel-info">
            					...
            					<div class="panel-body">
				    				...
				    				<div class="form_hieght">
			                            <label class="col-sm-6 control-label">Reader Status</label>
			                            <div class="col-md-6" id="open-by" name="open-by">
			                                <?php echo $this->Form->input('card_reader', array('options'=>$reader_status, 'class'=>'form_width','div'=>false,'label'=>false));?>
			                            </div>
			                        </div>
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
					      		<div class="panel panel-info">
	            					<div class="panel-heading"><b>Instant Card Reader Fail Site List</b> </div>
	            					<div class="panel-body">   
																							...
																							foreach ($zone_data as $key => $value) {
																								if($value1['Zone']['parent_id']==$value['Zone']['id']){ 
																									...
																									<tr class="">
																										...
																										<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;">
																	                                        <?php
																	                                            if($zone['Testing']['card_reader'] == 1){
																	                                                echo 'Fail';
																	                                            }
																	                                            elseif($zone['Testing']['card_reader'] == 0){
																	                                                echo 'OK';
																	                                            }
																	                                        ?>
																										</td>
