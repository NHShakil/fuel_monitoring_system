...
<?php $this->assign('title', 'Site Status Report');?>
<div class="content-wrapper">
    <section class="content">
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Site Status Report'); ?></h2>
        		</div>
        	</div>
    			...
    			<div class="col-md-12">
					<div class="row">
				      	<div class="col-sm-4">
				      		<div class="panel panel-info">
            					...
            					<div class="panel-body">
				    				...
				    				<div class="form_hieght">
			                            <label class="col-sm-6 control-label">Site Status</label>
			                            <div class="col-md-6" id="open-by" name="open-by">
			                                <?php echo $this->Form->input('status', array('options' =>$live_status,'class'=>'form_width','div'=>false,'label'=>false ));?>
			                            </div>
			                        </div>
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
					      		<div class="panel panel-info">
	            					<div class="panel-heading"><b>Live or Dead Site Status Report</b> </div>
	            					<div class="panel-body">   
																									...
																									<tr class="">
																										...
																										<?php
																											if($zone['Testing']['status'] == 1){?>
																												<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo 'Null';?></td><?php
																											}
																											else{?>
																												<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo time_dutation($zone['Testing']['full_date_time']); ?></td>
																											<?php }
																										?>
																									</tr><?php
																								}
...
<?php
	function time_dutation($value){
        ...
        $time_durationn = $hours.':'.$minutes.':'.$seconds;    
