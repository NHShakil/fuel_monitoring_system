...
<script type="text/javascript">
	...
	/*$(document).ready(function(){
		...
		$('#insert_data').on('submit', function(event){
			...
			{
				if($('#low-voltage').val() == ''){
					alert("Please Select Voltage");
					return false;
				}
			}
			else if($('#low-voltage').val() == '')
			{
				if($('#high-voltage').val() == ''){
					alert("Please Select Voltage");
					return false;
...
<?php $this->assign('title', 'Instant Voltage Report');?>
<div class="content-wrapper">
    <section class="content">
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Instant Voltage Low Site'); ?></h2>
        		</div>
        	</div>
    			...
    			<div class="col-md-12">
					<div class="row">
				      	<div class="col-sm-4">
				      		<div class="panel panel-info">
            					...
            					<div class="panel-body">
            						<?php echo $this->Form->create(false,array('class'=>'form-horizontal','id'=>'insert_data')); ?> 
				    				...
				    				<div class="form_hieght">
			                            <label class="col-sm-6 control-label">High Voltage</label>
			                            <div class="col-md-6" id="high-voltage" name="high-voltage">
			                                <?php echo $this->Form->input('high_voltage', array('class'=>'form_width','div'=>false,'label'=>false,'type'=>'number','max'=>60,'min'=>50,'placeholder'=>'56','step'=>0.5));?>
			                            </div>
			                        </div> -->

			                        <div class="form_hieght">
			                            <label class="col-sm-6 control-label">Low Voltage</label>
			                            <div class="col-md-6" id="low-voltage" name="low-voltage">
			                                <?php echo $this->Form->input('low_voltage', array('class'=>'form_width','div'=>false,'label'=>false,'type'=>'number','max'=>60,'min'=>40,'placeholder'=>'45','step'=>0.5));?>
			                            </div>
			                        </div>
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
					      		<div class="panel panel-info">
	            					<div class="panel-heading"><b>Instant Voltage Low Site List</b> </div>
	            					<div class="panel-body">   
								            ...
								            <div id = "report_page">
								                ...
								                <div id = "report_data">
								                	<table class="table table-striped">
														<thead>
															<tr class="text-center" bgcolor=#99ddff style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;">
																<th>SL NO</th>
																<th>Zone Name</th>
																<th>Sub Zone Name</th>
																<th>Site Name</th>
																...
																if(count($testing_site_data)>0){
																							...
																							foreach ($zone_data as $key => $value) {
																								if($value1['Zone']['parent_id']==$value['Zone']['id']){ 
																									...
																									<tr class="">
																										...
																										<td style="font-size: 13px; font-family: 'Times New Roman',Georgia,Serif;">
																	                                        <?php echo h($zone['Testing']['voltage']); ?>
																										</td>
																	...
																	elseif($flag_all==true){
																		...
																		foreach ($testing_site_data as $key1 => $value) {
																			foreach ($value as $key => $zone) {
																				foreach ($zone_data as $key => $value1) {
																					if($zone['zone_id']==$value1['Zone']['id']){
																						if($value1['Zone']['parent_id']!=''){
																							...
																							foreach ($zone_data as $key => $value) {
																								if($value1['Zone']['parent_id']==$value['Zone']['id']){ 
																									...
																									<tr class="">
																										...
																										<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo h($zone['site_name']);?></td>

																										<td style="font-size: 13px; font-family: 'Times New Roman',Georgia,Serif;">
																	                                        <?php echo h($zone['voltage']); ?>
																										</td>

																										<td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo h($zone['full_date_time']); ?></td>
																									</tr><?php
																								}
																							}
																						}
