       ...
       <div class= "row">
        <div class="col-md-12" >
            <div class="bar bar-primary bar-top">
              <h2 class="bar-title col-md-4"><?php echo __('Reports :: Regional Site Access Report '); ?></h2>
            </div>
          </div>
          ...
          <div class="row">
                ...
                <div class="col-sm-8">
                  <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading"> Regional Site Access Report </div>
                        <div class="panel-body">   
                            ...
                            <tbody>
                              <?php 
                                if(count($door_status_data)>0){
                                  if($regional_report_flag==true){
                                    foreach ($door_status_data as $key => $zone1){
                                    ...
                                    foreach ($door_status_data as $key => $zone1){
                                      foreach ($zone1 as $key => $zone) { ?>
                                        <tr class="">
                                          ...
                                          <td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo h($zone['door_open_user']);?></td>
                                          <td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo h($zone['door_open_by']);?></td>
                                          <td style="font-size: 13px; font-family: 'Times New Roman', Georgia, Serif;"><?php echo h($zone['door_open_time']); ?></td>
                                        </tr><?php 
                                      }
                                    }
                                  }
