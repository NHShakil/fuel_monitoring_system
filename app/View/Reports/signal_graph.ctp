       ...
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Signal Graph');?></h2>
        		</div>
        	</div>
    			...
    			<div class="col-md-12">
					<div class="row">
				      	<div class="col-sm-4">
				      		<div class="panel panel-info">
            					...
            					<div class="panel-body">
				    				...
				    				<!-- <div class="form_hieght">
			                            <label class="col-sm-6 control-label"> Signal Lebel</label>
				      	...
				      	<div class="col-sm-8">
				      		<div class="col-md-12">
				      			<div class="panel panel-info">
	            					<div class="panel-heading"><b> Signal Graph Presentation</b></div>
	            					<div class="panel-body">
								      		...
								      		<div id="container" style="min-width: 510px; height: 400px; margin: 0 auto"></div>
												<script type="text/javascript">
													<?php 
														...
														foreach ($datas as $key => $row) {
															if($row["TestingLogDevice"]["modified"]!=''){
																...
																$dataTable[]        ="{$row['TestingLogDevice']['signal_strenght']},";
									            			}	
														}
													?>
											        Highcharts.chart('container', {
											            ...
											            title: {
											                text: '<?php echo $site_name_graph;?> Time vs Signal'
											            },
											            subtitle: {
