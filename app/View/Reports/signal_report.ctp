...
<?php $this->assign('title', 'Instant Signal Report');?>
<div class="content-wrapper">
    <section class="content">
       <div class= "row">
    		<div class="col-md-12" >
        		<div class="bar bar-primary bar-top">
        			<h2 class="bar-title col-md-4"><?php echo __('Instant Signal Low Site'); ?></h2>
        		</div>
        	</div>
				      	...
				      	<div class="col-sm-4">
				      		<div class="panel panel-info">
            					...
            					<div class="panel-body">
			                        ...
			                        <div class="form_hieght">
			                            <label class="col-sm-6 control-label">Low Signal</label>
			                            <div class="col-md-6" id="site-signal" name="site-signal">
			                                <?php echo $this->Form->input('signal_strenght', array('class'=>'form_width','div'=>false,'label'=>false,'type'=>'number','max'=>30,'min'=>20,'placeholder'=>'20','step'=>0.5));?>
			                            </div>
			                        </div>
																							...
																							foreach ($zone_data as $key => $value) {
																								if($value1['Zone']['parent_id']==$value['Zone']['id']){ 
																									...
																									<tr class="">
																										...
																										<td style="font-size: 13px; font-family: 'Times New Roman',Georgia,Serif;">
																	                                        <?php echo h($zone['Testing']['signal_strenght']); ?>
																										</td>
																							...
																							foreach ($zone_data as $key => $value) {
																								if($value1['Zone']['parent_id']==$value['Zone']['id']){ 
																									...
																									<tr class="">
																										...
																										<td style="font-size: 13px; font-family: 'Times New Roman',Georgia,Serif;">
																	                                        <?php echo h($zone['signal_strenght']); ?>
																										</td>
