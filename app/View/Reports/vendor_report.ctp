       ...
       <div class= "row">
        <div class="col-md-12" >
            <div class="bar bar-primary bar-top">
              <h2 class="bar-title col-md-4"><?php echo __('Reports :: Vendor Site Access Log Report'); ?></h2>
            </div>
          </div>
            ...
            <div class="col-md-12">
              <div class="row">
                      ...
                      <div class="form_hieght">
                        ...
                        <div class="col-md-6">
                          <select id="user-type" name="user-type" class="form_width">
                            ...
                            <?php
                                foreach ($vendorType as $key => $value) {?>
                                    <option value="<?php echo $value["CardManagement"]["vendor_name"];?>"><?php echo $value['CardManagement']['vendor_name'];?></option>
                                    <?php 
                                }
                            ?>
                          </select>
                  ...
                  <div class="col-sm-8">
                    <div class="col-md-12">
                      <div class="panel panel-info">
                          <div class="panel-heading"> Vendor Site Access Report </div>
                          <div class="panel-body">   
