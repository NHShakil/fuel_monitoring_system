        ...
        <div class="col-md-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h1 class="bar-title col-md-2"><?php echo __('Role :: Edit'); ?></h1>
                </div>

                <div class="card-header">
                    
                    <?php echo $this->Html->link('<i class="fa fa-list"></i> List Roles', array('action' => 'index'),array('escape'=>false,'class'=>'btn btn-success')); ?>
						...
						<div class="col-md-10">
							...
							$existing_permission = $this->data['Role']['accesslist'];
								...
								foreach($acl_array as $m_key => $module):
									echo $this->Html->link('<span>'.strtoupper($m_key).'</span>', array(),array('escape'=>false,'class'=>'btn btn-info'));
