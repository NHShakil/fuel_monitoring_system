		...
		<div class="col-md-12">
            ...
            <div class="card card-info">
              	<div class="card-header">
                	<h3 class="bar-title col-md-2"><?php echo __('BTS :: Add'); ?></h3>
              	</div>
              	...
              	<div class="card-body">
                	...
                	<div class="form-group">
                  		<label>Zone</label>
                  		<?php echo $this->Form->input('zone_id',array('options'=>$zones, 'class'=>'form-control select2','label'=>false, 'div'=>false));?>
                	</div>
	                ...
	                <div class="form-group">
	                  	...
	                  	<div class="input-group">
	                    	...
	                    	<?php echo $this->Form->input('SiteModuleId',array('class'=>'form-control','label'=>false, 'div'=>false,'required'=>true));?>
	                ...
	                <div class="form-group">
	                  	...
	                  	<div class="input-group">
	                    	...
	                    	<?php echo $this->Form->input('site_name',array('class'=>'form-control','label'=>false, 'div'=>false,'required'=>true));?>
	                ...
	                <div class="form-group">
                  		...
                  		<?php echo $this->Form->input('site_category',array('options'=>$site_category, 'class'=>'form-control select2','label'=>false, 'div'=>false));?>
                	</div>
