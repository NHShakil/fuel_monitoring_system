        ...
        <div class= "row">
            <div class="col-md-12" >
                ...
                <div class="row bar bar-secondary">
                    <div class="col-md-12">
                        <?php echo $this->Html->link('<i class="fa fa-list"></i><span> All Users</span>', array('action' => 'dashboard'),array('escape'=>false,'class'=>'btn btn-info')); ?>
                    </div>  
                </div>
                    ...
                    <div class="col-md-12">
                        <?php echo $this->Form->create('Testing',array('class'=>'form-horizontal'));?> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <?php echo $this->Form->input('server_ip',array('class'=>'form-control', 'label' =>false,'div'=>false));?>
                                </div>
                            </div>
